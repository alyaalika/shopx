  ...
  (function ($) {
      ...
      var methods = {
          switch: function _switch(tab_id) {
              ...
              if (elm.hasClass('cm-ajax') && $('#' + 'content_' + tab_id).length == 0) {
                  tabs_elm.after('<div id="content_' + tab_id + '"></div>');
              ...
              $(this).each(function () {
                  ...
                  $('li.cm-ajax.cm-js').each(function () {
                      ...
                      if (self.hasClass('active')) {
                          var content = $('#content_' + tab_id).html().replace(/<!--.*?-->/, '').replace(/(^\s+|\s+$)/, '');
