...
// Sample query to retrieve data from the 'game' table
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="glav.php">Членый </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="cart.php">Смазки</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="log1.php">Каталог</a>
            </li>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="sexDollsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Секс куклы
                </a>
                <div class="dropdown-menu" aria-labelledby="sexDollsDropdown">
                    <a class="dropdown-item" href="priziki.php">призики</a>
                    <a class="dropdown-item" href="vibrarori.php">выбраторый</a>
                    <a class="dropdown-item" href="trusiki.php">трусики</a>

    <a class="dropdown-item" href="analprobki.php">Анальные пробки</a>

    <a class="dropdown-item" href="bdsm.php">бдсм товарый</a>
    <a class="dropdown-item" href="analprob.php">Анальные мострубаторый</a>
    <a class="dropdown-item" href="chelngame.php">члены игрушки</a>
    <a class="dropdown-item" href="kukli.php">Куклый</a>
...
<div class="container">
    ...
    <form method="post" enctype="multipart/form-data" action="upload.php" class="mt-4">
    ...
    <div class="row mt-4">
        ...
        while($row = mysqli_fetch_assoc($result)) {
            echo '<div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="' . $row['image_path'] . '" class="card-img-top" alt="Изображение товара">
                        <div class="card-body">
